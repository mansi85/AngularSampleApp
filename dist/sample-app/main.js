...
var ContentComponent = /** @class */ (function () {
    function ContentComponent(_UsersService) {
        ...
        // this.content = `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque cursus scelerisque arcu, sed egestas purus rhoncus non. In ac sagittis dolor. Sed ligula nibh, finibus a euismod vel, aliquam quis magna. Donec pulvinar lacinia accumsan. Proin nulla sapien, condimentum at ante eu, congue hendrerit leo. Phasellus id enim eget dui mattis interdum quis sit amet nulla. Pellentesque vel viverra nulla, eget ultrices enim. Nulla quam lorem, gravida ac libero nec, egestas dignissim ex. Praesent non leo laoreet, pretium ipsum id, ornare orci.
        // `
    }
    ...
    ContentComponent.prototype.changeName = function () {
        this._UsersService.changeName("Coffee", "500");
    };
...
var GridComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])("listing"),
...
module.exports = "<ul>\n<li *ngFor=\"let item of compListing\">{{item.user}}\n  <ul>\n  <li *ngFor=\"let item of compListing\">{{item.user}}</li>\n  </ul>\n  </li>\n</ul>\n"
...
var ListingComponent = /** @class */ (function () {
    function ListingComponent(_UsersService) {
        var _this = this;
        this._UsersService = _UsersService;
        // this.listing = this._UsersService.getData();
        this._UsersService.getData()
            .subscribe(function (data) {
            _this.compListing = data;
        });
    }
    ListingComponent.prototype.ngOnInit = function () {
        console.log("list is", this.compListing);
    };
...
var UsersService = /** @class */ (function () {
    function UsersService() {
        ...
        this.compListing = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](this.listing); //default data is to be given when made through behaviour subject. lIting is now observable
    }
    UsersService.prototype.updateData = function () {
        this.compListing.next([]);
    };
    UsersService.prototype.getData = function () {
        return this.compListing;
    };
    UsersService.prototype.changeName = function (name, newPrice) {
        this.compListing.next([{
                user: name,
                price: newPrice
            }]);
...
module.exports = __webpack_require__(/*! C:\Users\Manisha\sample-app\src\main.ts */"./src/main.ts");
